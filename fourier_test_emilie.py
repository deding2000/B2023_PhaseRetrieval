...
#%%
# results8c = test_fourier(m=8,n=2,number_combinations=100, isComplex=True)
# results6c = test_fourier(m=6,n=2,number_combinations=1000, isComplex=True)
results4c = test_fourier(m=6,n=4,number_combinations=1000, isComplex=True)

#%%
plt.plot(results4c["success"])
#%%
